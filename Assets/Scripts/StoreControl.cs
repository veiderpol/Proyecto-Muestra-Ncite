...
public class StoreControl : MonoBehaviour{
    ...
    void Start(){
        ...
        if(scene.name == "Menu"){
            ...
            jsonString = File.ReadAllText(Application.streamingAssetsPath + "/PlayerStats.json");
            if (jsonString != "") 
            {
    ...
    public void Salir(){
        ...
        File.WriteAllText(Application.streamingAssetsPath + "/PlayerStats.json",itemData.ToString());
        string jsonString = File.ReadAllText(Application.streamingAssetsPath + "/PlayerStats.json");
